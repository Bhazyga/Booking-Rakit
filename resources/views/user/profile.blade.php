...
<head>
  ...
  <title>Booking Rakit - Profil</title>
              ...
              <div class="col-md-12 border-right">
                <div class="p-3 py-5">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">Setting Profil</h4>
                  </div>
                  <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="row mt-2">
                      <div class="col-md-12 mb-1"><label class="labels">Nama Lengkap</label><input type="text" name="name"
                          class="form-control" placeholder="Nama Lengkap" value="{{$user->name}}"></div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-12 mb-1"><label class="labels">Nomor Telepon</label><input name="phone"
                          type="text" class="form-control" placeholder="Masukan Nomor Telpon Anda" value="{{$user->phone}}">
                      </div>
                    </div>
                    <div class="row mt-3">

                      <div class="col-md-12"><label class="labels">Alamat </label><input type="text" name="adress"
                          class="form-control" placeholder="Masukkan Alamat" value="{{$user->adress}}"></div>
                    </div>
                      ...
                      <div class="col-md-12 border-right">
                        <form action="{{route('updatePassword')}}" method="post">
                          ...
                          <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6"><label class="labels">Konfirmasi Password</label><input
                            ...
                            <div class="mt-5 "><button class="btn btn-outline-success profile-button"
                                type="submite">Simpan Profil</button></div>
                          </div>
                        </form>
                        {{-- delete acc --}}
                        <hr>
                        <div class="mt-2">
                          <form action="{{route('profile.destroy')}}" method="post" id="deleteacc">
                            ...
                            <div class=""><button class="btn btn-danger profile-button w-100" type="button"
                                onclick="alerting()">DELETE AKUN</button></div>
                          </form>

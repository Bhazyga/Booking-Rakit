        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div class="col ">
            <div class="card ">
              ...
              <a href="/dashboard/pemilik/{{$item->id}}">
              ...
              <div class="card-footer text-success "> <a href="/dashboard/pemilik/{{$item->id}}"
                  class="btn btn-success btn-rounded btn-block btn-sm w-100"><i class="bi bi-alarm"></i> Booking Sekarang!</a>
              </div>
